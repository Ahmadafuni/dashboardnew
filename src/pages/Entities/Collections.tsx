...
import { deleteCollection, getAllCollections, getCollectionById } from "@/services/Collection.services.ts";
import {Collection, CollectionId, newCollectionModal, updateCollectionModal} from "@/store/Collection.ts";
...
export default function Collections() {
                ...
                return (
                    <div className="flex gap-1">
                        ...
                        <DeleteConfirmationDialog
                            deleteRow={() => deleteCollection(setCollections, row.original.Id)}
                        />
                    </div>
                );
            },
    ...
    return (
        <div className="w-full space-y-2">
            <NewCollection getAllCollections={() => getAllCollections(setCollections)} />
            <UpdateCollection getAllCollections={() => getAllCollections(setCollections)} />
