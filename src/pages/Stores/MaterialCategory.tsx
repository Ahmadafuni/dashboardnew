...
export default function MaterialCategories() {
    ...
    const [materialCategories, setMaterialCategories] = useState<MaterialCategoryType[]>([]);
    const setNewMaterialCategoryModal = useSetRecoilState(newMaterialCategoryModal);
    const setUpdateMaterialCategoryModal = useSetRecoilState(updateMaterialCategoryModal);
                ...
                return (
                    <div className="flex gap-1">
                        ...
                        <DeleteConfirmationDialog
                            deleteRow={() => deleteMaterialCategory(setMaterialCategories, row.original.Id)}
                        />
                    </div>
                );
            },
    ...
    return (
        <div className="w-full space-y-2">
            ...
            <UpdateMaterialCategory getMaterialCategories={getAllMaterialCategories} />
            ...
            <div className="space-y-2">
                ...
                <div className="rounded-md border overflow-x-scroll">
                    <DataTable columns={materialCategoryColumns} data={materialCategories} />
                </div>
            </div>
        </div>
    );
