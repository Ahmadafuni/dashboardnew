...
import {materialMovementId, updateMaterialMovementModal} from "@/store/MaterialMovement.ts";
            ...
            cell: ({ row }) => {
                return (
                    <div className="flex gap-1">
                        ...
                        <DeleteConfirmationDialog deleteRow={() => deleteMaterialMovement(setMaterialMovements, row.original.Id, materialId)} />
                    </div>
                );
            },
        },
